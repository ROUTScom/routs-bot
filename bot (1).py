...
ADMIN_CHAT_ID = os.getenv("ADMIN_CHAT_ID")  # твой личный chat_id, чтобы получать уведомления
...
WELCOME_TEXT = (
    ...
    "ИИ, и обошли конкурентов на старте. Курс ROUTS про то, как оказаться "
    "среди вторых.\n\n"
...
BUY_TEXT = (
    "Рады встретить вас в нашем комьюнити и помочь разобраться в ИИ "
    "одними из первых.\n\n"
    "Для первого потока держим минимальную цену. Сейчас курс стоит "
    "<b>$49</b>, и эта цена стабильна до конца июля, дальше будет $99.\n\n"
    "Шесть полноценных уроков по цене одного ужина, а пользы от них "
...
FALLBACK_TEXT = (
    ...
    f"Если хочется быстрее — пишите прямо @{MANAGER_USERNAME}.\n\n"
    "А пока можно посмотреть меню:"
)
